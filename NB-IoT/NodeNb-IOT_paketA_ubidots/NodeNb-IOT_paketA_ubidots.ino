...
//-----------------------------------------ubidots token
String token = "BBFF-E1zxYEPSBgnUVePlVrwzWlwUsk5qGU";   //your ubidots token 
String devicelabel = "misred";                     //Your device label
...
void SendTo()
{
  ...
  String le;
  String var;
  var="{\"rain\":"+ String(dailyRain,2) +",\"level\":" + String(ketinggian)+"}";
  num=var.length();
  le=String(num);
